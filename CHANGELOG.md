...
- Press, drag and release works in the menu – like native macOS menus, you can hold the mouse down on the menu bar icon, slide over items (they highlight under the pressed pointer, including into submenus) and release to activate the item under the cursor. Releasing outside any item does nothing instead of triggering the pressed row
