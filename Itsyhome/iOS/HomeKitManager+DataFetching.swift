...
extension HomeKitManager {
    ...
    static let observedCharacteristicTypes: Set<String> = [
        ...
        CharacteristicTypes.occupancyDetected,
        CharacteristicTypes.leakDetected,
        CharacteristicTypes.smokeDetected,
        CharacteristicTypes.carbonMonoxideDetected,
        CharacteristicTypes.carbonDioxideDetected,
        CharacteristicTypes.airQuality,
        CharacteristicTypes.carbonDioxideLevel,
        CharacteristicTypes.carbonMonoxideLevel,
        CharacteristicTypes.vocDensity,
    ...
    func buildServiceData(from svc: ServiceInfo) -> ServiceData {
        ...
        return ServiceData(
            ...
            occupancyDetectedId: charId(CharacteristicTypes.occupancyDetected),
            leakDetectedId: charId(CharacteristicTypes.leakDetected),
            ...
            airQualityId: charId(CharacteristicTypes.airQuality),
            carbonDioxideLevelId: charId(CharacteristicTypes.carbonDioxideLevel),
            carbonMonoxideLevelId: charId(CharacteristicTypes.carbonMonoxideLevel),
            vocDensityId: charId(CharacteristicTypes.vocDensity),
