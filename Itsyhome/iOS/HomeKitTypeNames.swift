...
enum HomeKitTypeNames {
    ...
    static func serviceName(_ type: String) -> String {
        ...
        case ServiceTypes.occupancySensor: return "OccupancySensor"
        case ServiceTypes.leakSensor: return "LeakSensor"
    ...
    static func characteristicName(_ type: String) -> String {
        ...
        case CharacteristicTypes.occupancyDetected: return "OccupancyDetected"
        case CharacteristicTypes.leakDetected: return "LeakDetected"
        case CharacteristicTypes.smokeDetected: return "SmokeDetected"
        case CharacteristicTypes.carbonMonoxideDetected: return "CarbonMonoxideDetected"
        case CharacteristicTypes.carbonDioxideDetected: return "CarbonDioxideDetected"
